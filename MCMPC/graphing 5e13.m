...
legend('I 10 fA/cm^2','II 100 fA/cm^2', 'III 1000 fA/cm^2','IV \tau_{bulk}= 500 us','V \tau_{bulk} = 50 us', 'Location', 'SouthWest')
...
hold on
loglog (dN_1a(30:end), tau_1a(30:end),'x', dN_2a(10:end), tau_2a(10:end),'x',dN_3a(3:end), tau_3a(3:end),'x',dN_4a(3:end), tau_4a(3:end),'x',dN_5a(3:end), tau_5a(3:end),'x')
loglog (dN_1b(50:end), tau_1b(50:end),'x')
axis([1e13 10e15 1e-5 100e-3])
xlabel ('\Delta\it{n}\rm{_{ave} (cm^{-3})}')
ylabel ('\tau_{eff} (s)')
legend('I 10 fA/cm^2','II 100 fA/cm^2', 'III 1000 fA/cm^2','IV \tau_{bulk}= 500 us','V \tau_{bulk} = 50 us', 'Location', 'NorthWest')